    ...
    <li class="<?php if ($model->active) echo "active"; ?>">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li>
                    <?= Html::a(FontAwesome::icon('pencil'), null, ['onclick' => ModalWindow::showForm(['/pages/page/form'], $model->id, '#dropdownMenuControl'), 'title' => 'Редактировать']) ?>
                    ...
                    <?= Html::a(FontAwesome::icon('trash'), null, ['onclick' => ModalWindow::deleteItem('/pages/page/delete', $model->id, '#dropdownMenuControl'), 'title' => 'Удалить']) ?>
                </li>
                ...
                <?php foreach ($model->child as $child) { ?>
                    <li>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <?= Html::a(FontAwesome::icon('pencil'), null, ['onclick' => ModalWindow::showForm(['/pages/page/form'], $child->id), 'title' => 'Редактировать']) ?>
                                    ...
                                    <?= Html::a(FontAwesome::icon('plus'), null, ['onclick' => ModalWindow::showForm(['page/form'], ['id' => 0, 'parent_id' => $child->id]), 'title' => 'Создать подраздел']) ?>
                                    <?= Html::a(FontAwesome::icon('trash'), null, ['onclick' => ModalWindow::deleteItem('/pages/page/delete', $child->id, '#dropdownMenuControl'), 'title' => 'Удалить']) ?>
                                </li>
